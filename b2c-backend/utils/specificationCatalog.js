export const APPROVED_SPECIFICATION_VALUES = [
    { spec: "Material", name: "Silk", active: 1 },
    { spec: "Material", name: "Copper", active: 1 },
    { spec: "Material", name: "cotton", active: 1 },
    { spec: "Material", name: "Lenin", active: 1 },
